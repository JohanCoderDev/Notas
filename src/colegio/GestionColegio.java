...
public class GestionColegio {
   ...
   public GestionColegio(String document, String name, String email, String gender) {
...
class Node {
    GestionColegio student;
    Node left;
    Node right;
    
    public Node(GestionColegio student){
...
class BinarySearchTree {
    ...
    public void insert(GestionColegio student){
        checkDuplicateDocument(student.document);
    ...
    private void checkDuplicateDocument(String document) {
        if (searchDocument(root, document)) {
            throw new IllegalArgumentException("Error: El número de documento ya está registrado.");
        }
    }
    
    private boolean searchDocument(Node node, String document) {
        if (node == null) {
            return false;
        }
        
        if (node.student.document.equals(document)) {
            return true;
        }
        
        return searchDocument(node.left, document) || searchDocument(node.right, document);
    }
...
//     * @param unAlumno 
//     */
//    public static void agregarAlumno(Alumno student){
